...
List<Event> listEvents = [
  Event(
    ...
    description: "Jika anda seorang Dokter Umum, Perawat, Bidan, Analis, atau Rekam Medik silahkan daftarkan diri anda. Saat ini...",
    rating: 4.8,
    isFavourite: true,
    isPopular: true,
    jadwal: "2 Juli 2021"
  ...
  Event(
    ...
    description: "Semakin derasnya hujan yang turun belakangan ini, membuat beberapa lokasi di Kota Jakarta mengalami banjir hebat. Oleh karena itu ...",
    rating: 4.1,
    isPopular: true,
